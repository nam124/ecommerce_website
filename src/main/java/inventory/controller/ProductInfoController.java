...
public class ProductInfoController {
	...
	@RequestMapping(value = { "/web/list", "/web/list/","/web"})
	public String redirect1() {
		return "redirect:/web/list/1";
	}
	@RequestMapping(value = "/web/list/{page}")
	public String showProductInfoList1(Model model, HttpSession session,@ModelAttribute("searchFormWeb") ProductInfo productInfo,@PathVariable("page") int page) {
